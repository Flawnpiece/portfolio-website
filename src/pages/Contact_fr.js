    ...
    return (
        <div>
            ...
            <form class="center-form" ref={form} onSubmit={sendEmail} >
                ...
                <div class="">
                    <br />
                    <label for="meetingTimeInAugustOptional">Date de rencontre pour Aout (Optional)</label>
            ...
            <Link to="/home_fr" class="left-arrow"><img class="button-continue" src="https://flawnpiece.github.io/portfolio-website/assets/down-arrow.png" alt="" width="25%" /></Link>
